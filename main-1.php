...
<html lang="ko">
    ...
    <section class="big-img-container" id="design-1">
        <div class="container-fluid h-100">
            <div class="row h-100">
                <div class="col inner-box h-100">
                    <div class="visual-box">
                        <div class="visual-box-sentence">
                            <h2 class="animated slow fadeInRight"><span>Singapore<span></h2>
                            <p class="text-in-back animated slow delay-1s fadeInUp">
                                메트라이프 대상자님들의 <em class="typo-1">열정</em>과 <em class="typo-1">가능성</em>이 만나는 곳으로 여러분을 초대합니다.
                            </p>
                        </div>
...
var vBoxH = $(".text-in-back").outerWidth();
$(".text-in-back").css({
